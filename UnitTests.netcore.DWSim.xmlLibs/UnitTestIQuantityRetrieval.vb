...
Namespace UnitTests.netcore.DWSim.xmlLibs
	...
	Inherits testOutputHelper
		...
		Sub IQuantityRetrieval_sandbox_IEngineeringEnumerableSequenceComparison()
			...
			'' this test checks if the sequences of doubles
			'are equal for the IEngineeringEnumerable generated by the IQuantityRetrieval type
			' it does not test the capabiilty of generating the unit conversion yet
